...
client.on('ready',() => {
  ...
  client.user.setActivity('!zg help | www.zg-gaming.co', { type: 'PLAYING' })
    .then(presence => console.log(`Activity set to ${presence.game ? presence.game.name : '!zg help | www.zg-gaming.co'}`))
    .catch(console.error);
})
